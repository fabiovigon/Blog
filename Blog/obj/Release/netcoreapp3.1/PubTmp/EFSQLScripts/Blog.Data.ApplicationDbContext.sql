...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20210411232503_Initialize')
BEGIN
...
BEGIN
    CREATE TABLE [Posts] (
        ...
        CONSTRAINT [FK_Posts_AspNetUsers_ApproverId] FOREIGN KEY ([ApproverId]) REFERENCES [AspNetUsers] ([Id]) ON DELETE NO ACTION,
        CONSTRAINT [FK_Posts_AspNetUsers_CreatorId] FOREIGN KEY ([CreatorId]) REFERENCES [AspNetUsers] ([Id]) ON DELETE NO ACTION
    );
END;
...
BEGIN
    ...
    VALUES (N'20210411232503_Initialize', N'3.1.13');
END;
